...
public class HelloGit extends SpringBootServletInitializer implements EmbeddedServletContainerCustomizer { 
    ...
    public String helloWorld() {
        return "Hello World kubernetes 01 12-21: Spring-boot Sample Application using Maven and Docker , time : "+new Date();
    }
    
    public HelloGit(){
    	System.out.println("init bean kubernetes 01 12-21!");
    }
